<template>
    <f7-page>
        <!-- Navbar -->
        <f7-navbar back-link>
            <f7-nav-title>Lista de Pacientes</f7-nav-title>
            <f7-nav-right>
                    ...
                    <div class="item-content" v-else @click="selectPatient(contact[0], contact[1], contact[2])">
                        <div class="item-inner">
                            ...
                            <div class="item-after">
                                <f7-icon slot="media" material="phone" size="18px"></f7-icon> {{contact[2]}}
                            </div>
                        </div>
                    </div>
                </li>
...
<script>
    ...
    export default {
        ...
        created() {
            this.items = this.getPatientsList
        },
        computed: {
        ...
        methods: {
            ...
            selectPatient(code, name, phone) {
                this.$store.dispatch("setPatient", [code, name, phone]);
